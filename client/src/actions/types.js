...
// EBOOK
export const EBOOKS_LOADED = 'EBOOKS_LOADED'
export const EBOOK_LOADED = 'EBOOK_LOADED'

// CLIENT REGISTERED BY GET DIET
export const CLIENT_REGISTERED_BY_GET_DIET = 'CLIENT_REGISTERED_BY_GET_DIET'